...
export class AccountController {
  ...
  async getDependencies(@Param('id') id_institucion: string) {
  ...
  async search(
    ...
    return await this.accountService.search(
      limit,
      offset,
      text,
      id_institucion,
  ...
  async assignAccountOfficer(
    ...
    return await this.accountService.assingAccountOfficer(
      id_account,
      id_officer,
    );
  }
